...
export const PopupInputFormName = (props: PopupInputFormNameProps) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border-[0.5px] border-[#E1E1E1] min-w-[240px] bg-white shadow-[0_0_1px_rgba(0,0,0,0.5)] px-4">
      <div className="text-base leading-6 font-medium p-3">Input {selectedPopup} Name</div>
      <input
